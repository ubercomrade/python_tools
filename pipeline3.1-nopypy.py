...
def scan_best_by_inmode(path_to_python_tools, output, input_model, fasta_in, path_to_inmode, path_to_java):
    args = ['python3', path_to_python_tools + '/scan_best_by_inmode_alt.py',
           fasta_in,
           input_model,
           output,
           path_to_inmode,
...
#         file.write('{0}:thr={1},fpr={2};{3}:thr={4},fpr={5}\n'.format(name1, thr1, fpr1, name2, thr2, fpr2))
#     file.close()
#     args = ['python3', path_to_python_tools + 'montecarlo.py', '{}'.format(scores1), '{}'.format(scores2), '{}'.format(thr1), '{}'.format(thr2), '{}'.format(length), '{}'.format(results)]
#     r = subprocess.call(args)
#     pass
...
def pipeline_inmode_bamm(bed_path, training_sample_size, testing_sample_size,
    ...
    if not os.path.isfile(motifs + '/' + tag + '_BAMM_THRESHOLDS.txt'):
        ...
        args = ['python3', path_to_python_tools + '/get_threshold_for_bamm.py',
                path_to_promoters,
    ...
    if not os.path.isfile(motifs + '/' + tag + '_PWM_THRESHOLDS.txt'):
        ...
        args = ['python3', path_to_python_tools + '/get_threshold_for_pwm.py',
                path_to_promoters,
